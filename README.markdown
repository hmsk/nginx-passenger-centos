...
## Download Nginx
    cd ~/rpmbuild
    curl http://nginx.org/download/nginx-0.8.52.tar.gz -o SOURCES/nginx-0.8.52.tar.gz
...
The resulting RPM will be:
    ...
    ~/rpmbuild/RPMS/x86_64/nginx-passenger-0.8.52+2.2.15-1.x86_64.rpm

## When put this error
    lib/ruby/gems/1.8/gems/passenger-2.2.15/ext/nginx/StaticContentHandler.c:69: error: 'ngx_http_request_t' has no member named 'zero_in_uri'
